<?php
/**
 * Originally from Zend Framework
 * Adapated for CloudSplit for different output
 *
 * LICENSE
 *
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Lupin_View_Helper_FormMultiCheckbox extends Lupin_View_Helper_FormRadio
{
    /**
     * Input type to use
     * @var string
