<?php
/**
 * Frapi eAccelerator Cache Adapter Layer
 *
 * LICENSE
 *
 ...
 * @package   frapi
 * @link      http://bart.eaccelerator.net/doc/phpdoc/
 */
class Frapi_Cache_Adapter_Eaccelerator implements Frapi_Cache_Interface 
{
    /**
    ...
    {
        return eaccelerator_put($name, $value, $expiry);
    }
